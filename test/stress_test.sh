...
TESTS=(
    "../build/x86_64/debug/chaos_test_small:bbattery_smallcrush"
    "../build/x86_64/debug/chaos_test_crush:bbattery_crush"
    "../build/x86_64/debug/chaos_test_big:bbattery_bigcrush"
)
