 ...
 * File:         test_bbattery_smallcrush.c
 * Author:       agguro
 * Date:         August 20, 2026 
 * Description:  TestU01 SmallCrush battery test harness for the Chaos Service.
 ...
 *               via statistical test suites (TestU01 / SmallCrush).
 *
...
int main (void) {
    ...
    /* Execute the SmallCrush test battery */
